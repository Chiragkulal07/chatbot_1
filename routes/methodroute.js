...
router.post('/get', async (req, res) => {
    ...
    try {
        ...
        const prompt = `Please provide a thorough and method make some methods analysis of the following data.
        Output format make some infernces insights on the following input:
        1. Point 1
        2. Point 2
        3. Point 3
        Make it clear, structured, and easy to understand make methods based on the following.
        Data:
        ${data}`;
